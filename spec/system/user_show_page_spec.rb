...
describe 'Should show the view file of the user`s show page' do
  before do
    @user = User.create!(Name: 'user1', Photo: 'https://unsplash.com/photos/F_-0BxGuVvo', Bio: 'This is a bio',
                         PostsCounter: 3)
    @post1 = Post.create!(author: @user, Title: 'Post 1', Text: 'This is text1', CommentsCounter: 0,
                          LikesCounter: 0)
    @post2 = Post.create!(author: @user, Title: 'Post 2', Text: 'This is text2', CommentsCounter: 0,
                          LikesCounter: 0)
    @post3 = Post.create!(author: @user, Title: 'Post 3', Text: 'This is text3', CommentsCounter: 0,
                          LikesCounter: 0)
  end
